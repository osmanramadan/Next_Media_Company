  ...
  return (
    <footer>
      ...
      <div className={`flex flex-col sm:flex-row justify-center items-center mt-8 mx-2`}>
        <div className="text-sm text-white sm:text-left mx-7```jsx
import Link from 'next/link';
import React from 'react';
import style from './footer.module.css';
    ...
    <footer className={style.footerContainer}>
      <div className={style.footerContent}>
        ...
        <div className={`${style.item} text-start`}>
          ...
          <ul className="text-gray-500 font-medium">
            <li className="mb-4">
              <Link href="/services/videoproduction">
                <a className="hover:underline">Video Production</a>
              </Link>
            </li>
            <li className="mb-4">
              <Link href="/services/websitedesign">
                <a className="hover:underline">Website Design And Hosting</a>
              </Link>
            </li>
            <li className="mb-4">
              <Link href="/services/socialmediamanagement">
                <a className="hover:underline">Social Media Management</a>
              </Link>
            </li>
            <li className="mb-4">
              <Link href="/services/designlogo">
                <a className="hover:underline">Design Logo</a>
              </Link>
            </li>
            <li className="mb-4">
              <Link href="/services/animationvideoproduction">
                <a className="hover:underline">Animation Video Production</a>
              </Link>
            </li>
            <li className="mb-4">
              <Link href="/services/googleads">
                <a className="hover:underline">Google Ads</a>
              </Link>
            </li>
          </ul>
        </div>
        ...
        <div className={`${style.item} text-start`}>
          ...
          <ul className="text-gray-500 dark:text-gray-400 font-medium">
            <li className="mb-4">
              <Link href="/contact">
                <a className="hover:underline mt-2">Contact</a>
              </Link>
            </li>
            <li className="mb-4">
              <Link href="/about">
                <a className="hover:underline mt-2">About</a>
              </Link>
            </li>
            <li className="mb-4">
              <Link href="/articles">
                <a className="hover:underline mt-2">Articles</a>
              </Link>
            </li>
            <li className="mb-4">
              <Link href="/#services">
                <a className="hover:underline mt-2">Services</a>
              </Link>
            </li>
            <li className="mb-4">
              <Link href="/privacy&policy">
                <a className="hover:underline mt-2">Privacy & Policy</a>
              </Link>
            </li>
          </ul>
        </div>
          ...
          <ul className="text-gray-500 dark:text-gray-400 font-medium">
            ...
            <li className="mb-4">
              <div>
                ...
                <a href='https://web.whatsapp.com/' className='ml-2'>0100823766</a>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div className={`flex flex-col sm:flex-row justify-center items-center mt-8 mx-2`}>
        <div className="text-sm text-white sm:text-left mx-7">
          &copy; 2024 <Link href="/">OnlineMedia</Link>: All Rights Reserved
        </div>
